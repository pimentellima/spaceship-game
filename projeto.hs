...
data Nave = Nave { posicao :: (Double, Double), 
...
data Projetil = Projetil { posicaoProj :: (Double, Double), 
                           tempoProj :: Double, 
                           anguloProj :: Double,
...
visualization (SpaceWorld n1 n2) = 
                           ...
                           colored black $ solidPolygon [(-15, 15),(15, 15),(15, -15),(-15, -15)]
...
movimentaNaves t (SpaceWorld n1 n2) = (SpaceWorld n1 n2) { nave1 = novaPosicao t . novaVelocidade t . novoAngulo t $ n1, 
...
projetilNaves t (SpaceWorld n1 n2) = (SpaceWorld n1 n2) { nave1 = n1 { projeteis = viajaProjetil t (projeteis n1),
                                                                    projetilTempo = reduztempoProjetil t $ n1 },
                                                                    
                                                          nave2 = n2 { projeteis = viajaProjetil t (projeteis n2),
...
projetilInicial nave = Projetil { posicaoProj = posInicial, 
                           tempoProj = 5, 
...
destruicaoNaves (SpaceWorld n1 n2) = (SpaceWorld n1 n2) { nave1 = n1 { destruicao = atualizadestruicao n1 1 (destruicao n1) listaproj, projeteis = removeProjetil (SpaceWorld n1 n2) pN1 },
...
checaIntersec (p1, q1) (p2, q2) 
    ...
    | orientacaoSeg p1 q1 p2 /= orientacaoSeg p1 q1 q2 && 
      orientacaoSeg p2 q2 p1 /= orientacaoSeg p2 q2 q1 = True 

    | orientacaoSeg p1 q1 p2 == 0 && 
      orientacaoSeg p1 q1 q2 == 0 && 
      orientacaoSeg p2 q2 q1 == 0 && 
      orientacaoSeg p2 q2 q1 == 0 && 
      interceptaProj (p1, q1) (p2, q2) = True
    
    | otherwise = False 



interceptaProj (p1, q1) (p2, q2) = max (fst p1) (fst q1) >= min (fst p2) (fst q2) && 
